...
my_ui = fluidPage(
  ...
  div(
    ...
    column(
        width = 10,
        h1(class="page-header", 'TCGplayer Analyzer',  tags$small("by ***REMOVED***") ),
    ),
    column(
        width = 2,
        img(class = 'img-circle img-responsive', src='wolf.png', style = 'width:100px;') %>% a(href = 'https://twitter.com/***REMOVED***')
    )
  ),#2.0 application
  div(
      column(
