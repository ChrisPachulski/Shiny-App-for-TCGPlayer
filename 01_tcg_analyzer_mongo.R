pacman::p_load(mongolite,jsonlite,config, shiny,shinyjs,DT,shinyWidgets,shinythemes,shinyauthr,plotly,tidyquant,tidyverse,lubridate,anytime,bigrquery,plotly,fs,janitor,zoo,tidyquant)
source('00_scripts/tcg_analysis_functions.R')
source('00_scripts/shiny_functions.R')
source('00_scripts/generate_favorite_cards.R')
source('00_scripts/crud_operations_mongodb.R')

gaeas_cradle("***REMOVED***@gmail.com")
...
server = function(input, output, session){
    ...
    # User Data ----
    mongo_read_user_base(host       = config$host,
    ...
    output$website = renderUI({
        ...
        navbarPage(
            #useShinyjs(),
            #icon = img(class = 'img-circle img-responsive', src='wolf.png', style = 'width:100px;') %>% a(href = 'https://twitter.com/***REMOVED***'),
